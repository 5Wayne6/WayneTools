// pages/relationship-tool/relationship-tool.js
//引用js
var relationship = require("../../myhelper/others-helper/relationship.js");
Page({
    ...
    if (id == this.data.id3) { //如果是X 后退则清除两个字符
     ...
     // console.log(data);
      ...
      if (id == this.data.id14){//点击 = 处理
        ...
        wx.navigateTo({
          url: '../relationship-tool_about/relationship-tool_about',
        }) 
      }else{
        //如果字数大于22个则不要增加and提示关系态复杂啦
        if(data.length>=22){
