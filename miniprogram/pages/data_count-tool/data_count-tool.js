// pages/data_count-tool/data_count-tool.js
const util = require('../../myhelper/funtion-helper.js'); //引入时间函数
Page({
 ...
 2. 生命周期函数--监听页面加载
  ...
  btnGetDays:function(){
    ...
    if(days < 0){
      wx.showToast({
        title:'输入错误',
        image:'../../images/index-icon/wrong.png', //这是要用到的“错误”图片
        duration:1000
      })
    } else{
      that.setData({
      ...
      wx.showToast({
        title: '成功',
        image:'../../images/index-icon/right.png', //这是要用到的“成功”图片
        duration: 1000,
      })
    }
  },
